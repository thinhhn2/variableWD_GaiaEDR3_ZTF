file = "C:/Thinh Nguyen files/Villanova University/Summer Research 2020 Switzerland/Gaia EDR3 Data/Gaia EDR3 Variable White Dwarf Candidates Reselection/Reselection with ZTF DR5/Reference for Periodic Percentage/Data/g band timeseries.csv"
file.query = "C:/Thinh Nguyen files/Villanova University/Summer Research 2020 Switzerland/Gaia EDR3 Data/Gaia EDR3 Variable White Dwarf Candidates Reselection/Reselection with ZTF DR5/Reference for Periodic Percentage/Data/g band query result.csv"
...
for (i in 1:length(levels)) {
  ...
  filename.lc = sprintf("%d Light Curve Full.png",n)
  ...
  filename.lc = sprintf("%d Light Curve.png",n)
  png(file=filename.lc,width=700,height=520)
  par(mar=c(6,6,5,3)+.1)
  ...
  filename.lsp = sprintf("%d LSP.png",n)
  ...
  filename.pc = sprintf("%d Phase Curve.png",n)
